...
- 🎙️ **Voice Input**: Speak your content instead of typing
...
5. **Listen & Learn**: Play your audio with optional background music and soundscapes
...
- **ElevenLabs** - For the amazing text-to-speech API
